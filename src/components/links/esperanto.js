...
const EsperantoLinks = () => (
  <div className="linksCopy">
    ...
    <a
      target="_blank"
      rel="noreferrer"
      href="https://deon24.com/2015/12/23/jezyk-ktory-laczy-a-nie-dzieli-leszek-kordylewski-o-rocznicy-urodzin-polskiego-wynalazcy-jezyka-esperanto/"
    >
      Radio Interview in Polish - „Język który łączy”
    </a>
    <a
      target="_blank"
      rel="noreferrer"
      href="https://www.youtube.com/watch?v=ijqY8TpUAg0"
    >
      Tv Interview in Polish - A Dziś w Programie (youtube)
    </a>
    <a
      target="_blank"
      rel="noreferrer"
